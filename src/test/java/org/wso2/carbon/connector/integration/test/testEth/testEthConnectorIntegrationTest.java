...
* under the License.
*/
package org.wso2.carbon.connector.integration.test.testEth;
 ...
 */
public class testEthConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    @Test(enabled = true, groups = {"wso2.ei"}, description = "testEth test case")
